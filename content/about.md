...
<ul class="fa-ul">
  ...
  <li><i class="fa-li fa-brands {{< fa_icon weight="s" icon="signal-messenger" >}}"></i> <a href="https://signal.me/#eu/MBgOhP7hkeHNHETdbbPSnyaIxR24sLUdTLZsrA4zwLk1pSLI601DSI1AiR-M-jOH">jmgilligan.91</a> on Signal</li>
  <li><i class="fa-li {{< fa_icon weight="s" icon="envelope" >}}"></i> <a href="mailto:j.magnolia.gilligan@vanderbilt.edu">j.magnolia.gilligan@vanderbilt.edu</a></li>
  <li><i class="fa-li {{< fa_icon weight="s" icon="envelope" >}}"></i> <a href="mailto:magnolia.gilligan@pm.me">magnolia.gilligan@pm.me</a> on Proton Mail</li>
</ul>
